...
function CreateRequest() {
  return (
    <React.Fragment>
      {/* prettier-ignore */}
      <div class="" style={{ backgroundColor: "white", borderRadius: "5px"}} className=""> {/* Form Container */}
        
        <div> 
          <div>
            
          </div>
            <div className="border-bottom p-2 h3 font-weight-bold ">  {/* Job Order Form */}
                Job Order Form
            </div>

            <form id="joborder"> {/* Job Order Form input boxes*/}
                <div class="p-2 form-row"> {/* Row 1 */}
                ...
                <div class=" p-2 form-row"> {/* Row 3 */}
                  ...
                  <div class="col">
                    ...
                    <input type="number" min="1" class="border-dark form-control" placeholder="Input Quantity"></input>
                  </div>

                </div>

                <div class=" p-2 form-row"> {/* Row 4 */}
                ...
                <div class="col"> 
                  ...
                  <div class="col">
                    ...
                    <input type="text" class="border-dark form-control" placeholder="(To be filled by LESO during the inspection)" disabled></input>
                  </div>
                ...
                <div class=" p-2 form-row"> {/* Row 5 */}
                  ...
                  <div class="p-2 form-row"> {/* Row 6 */}

                  <div class="col">
                    <label class="font-weight-bold" for="inputEmail4">Problem Reported</label> <br />
                    <textarea  style={{ height: "150px", width: "100%", borderRadius: "5px"}} name="" id=""placeholder=" (To be filled by LESO during the inspection)" disabled></textarea>
                  </div>

                </div> 

                <input class="m-2 btn btn-primary " type="submit" />
            </form>
